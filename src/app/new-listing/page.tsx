...
export default async function NewListingPage() {
    ...
    if (!user) {
        return (
            <div className="container">
                <div>You neet to logged in to post a job</div>
            </div>
        )
    }
    ...
    for (const activeMemberrship of activeOrganizationMemberships) {
        const organization = await workos.organizations.getOrganization(activeMemberrship.organizationId)
    ...
    return (
        <div className="container">
            <div>
                ...
                <p className="text-gray-500 text-sm mb-2">Select a company to create a hob add for </p>
                <div>
                ...
                <Link
                    className="inline-flex gap-2 items-center bg-gray-200 px-4 py-2 rounded-md i mt-6"
                    href={'/new-company'}>
                    Create new company
                    <FontAwesomeIcon className="h-4" icon={faArrowRight} />
                </Link>
